...
sub-docs-qmake_all:  FORCE
	...
	cd docs/ && $(QMAKE) /auto/bunter_usr23/townleym/wc20160420/docs/docs.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile
	cd docs/ && $(MAKE) -f Makefile qmake_all
sub-docs: FORCE
	@test -d docs/ || mkdir -p docs/
	cd docs/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr23/townleym/wc20160420/docs/docs.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile
sub-docs-make_first: FORCE
	@test -d docs/ || mkdir -p docs/
	cd docs/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr23/townleym/wc20160420/docs/docs.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile 
sub-docs-all: FORCE
	@test -d docs/ || mkdir -p docs/
	cd docs/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr23/townleym/wc20160420/docs/docs.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile all
sub-docs-clean: FORCE
	@test -d docs/ || mkdir -p docs/
	cd docs/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr23/townleym/wc20160420/docs/docs.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile clean
sub-docs-distclean: FORCE
	@test -d docs/ || mkdir -p docs/
	cd docs/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr23/townleym/wc20160420/docs/docs.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile distclean
sub-docs-install_subtargets: FORCE
	@test -d docs/ || mkdir -p docs/
	cd docs/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr23/townleym/wc20160420/docs/docs.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile install
sub-docs-uninstall_subtargets: FORCE
	@test -d docs/ || mkdir -p docs/
	cd docs/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr23/townleym/wc20160420/docs/docs.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile uninstall
...
sub-docs-check:
	@test -d docs/ || mkdir -p docs/
	cd docs/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr23/townleym/wc20160420/docs/docs.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile check
sub-textui-check:
	@test -d textui/ || mkdir -p textui/
...
sub-docs-distdir: FORCE
	@test -d docs/ || mkdir -p docs/
	cd docs/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr23/townleym/wc20160420/docs/docs.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -e -f Makefile distdir DISTDIR=$(DISTDIR)/docs
