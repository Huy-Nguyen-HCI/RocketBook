...
sub-gui-qmake_all:  FORCE
	...
	cd gui/ && $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/gui/gui.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile
	cd gui/ && $(MAKE) -f Makefile qmake_all
sub-gui: FORCE
	@test -d gui/ || mkdir -p gui/
	cd gui/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/gui/gui.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile
sub-gui-make_first: FORCE
	@test -d gui/ || mkdir -p gui/
	cd gui/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/gui/gui.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile 
sub-gui-all: FORCE
	@test -d gui/ || mkdir -p gui/
	cd gui/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/gui/gui.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile all
sub-gui-clean: FORCE
	@test -d gui/ || mkdir -p gui/
	cd gui/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/gui/gui.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile clean
sub-gui-distclean: FORCE
	@test -d gui/ || mkdir -p gui/
	cd gui/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/gui/gui.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile distclean
sub-gui-install_subtargets: FORCE
	@test -d gui/ || mkdir -p gui/
	cd gui/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/gui/gui.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile install
sub-gui-uninstall_subtargets: FORCE
	@test -d gui/ || mkdir -p gui/
	cd gui/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/gui/gui.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile uninstall
sub-docs-qmake_all:  FORCE
	@test -d docs/ || mkdir -p docs/
	cd docs/ && $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/docs/docs.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile
	cd docs/ && $(MAKE) -f Makefile qmake_all
sub-docs: FORCE
	@test -d docs/ || mkdir -p docs/
	cd docs/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/docs/docs.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile
sub-docs-make_first: FORCE
	@test -d docs/ || mkdir -p docs/
	cd docs/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/docs/docs.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile 
sub-docs-all: FORCE
	@test -d docs/ || mkdir -p docs/
	cd docs/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/docs/docs.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile all
sub-docs-clean: FORCE
	@test -d docs/ || mkdir -p docs/
	cd docs/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/docs/docs.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile clean
sub-docs-distclean: FORCE
	@test -d docs/ || mkdir -p docs/
	cd docs/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/docs/docs.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile distclean
sub-docs-install_subtargets: FORCE
	@test -d docs/ || mkdir -p docs/
	cd docs/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/docs/docs.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile install
sub-docs-uninstall_subtargets: FORCE
	@test -d docs/ || mkdir -p docs/
	cd docs/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/docs/docs.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile uninstall
sub-textui-qmake_all:  FORCE
	@test -d textui/ || mkdir -p textui/
	cd textui/ && $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/textui/textui.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile
	cd textui/ && $(MAKE) -f Makefile qmake_all
sub-textui: FORCE
	@test -d textui/ || mkdir -p textui/
	cd textui/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/textui/textui.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile
sub-textui-make_first: FORCE
	@test -d textui/ || mkdir -p textui/
	cd textui/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/textui/textui.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile 
sub-textui-all: FORCE
	@test -d textui/ || mkdir -p textui/
	cd textui/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/textui/textui.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile all
sub-textui-clean: FORCE
	@test -d textui/ || mkdir -p textui/
	cd textui/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/textui/textui.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile clean
sub-textui-distclean: FORCE
	@test -d textui/ || mkdir -p textui/
	cd textui/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/textui/textui.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile distclean
sub-textui-install_subtargets: FORCE
	@test -d textui/ || mkdir -p textui/
	cd textui/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/textui/textui.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile install
sub-textui-uninstall_subtargets: FORCE
	@test -d textui/ || mkdir -p textui/
	cd textui/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/textui/textui.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile uninstall
...
sub-gui-check:
	@test -d gui/ || mkdir -p gui/
	cd gui/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/gui/gui.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile check
sub-docs-check:
	@test -d docs/ || mkdir -p docs/
	cd docs/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/docs/docs.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile check
sub-textui-check:
	@test -d textui/ || mkdir -p textui/
	cd textui/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/textui/textui.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -f Makefile check
...
sub-gui-distdir: FORCE
	@test -d gui/ || mkdir -p gui/
	cd gui/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/gui/gui.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -e -f Makefile distdir DISTDIR=$(DISTDIR)/gui

sub-docs-distdir: FORCE
	@test -d docs/ || mkdir -p docs/
	cd docs/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/docs/docs.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -e -f Makefile distdir DISTDIR=$(DISTDIR)/docs

sub-textui-distdir: FORCE
	@test -d textui/ || mkdir -p textui/
	cd textui/ && ( test -e Makefile || $(QMAKE) /auto/bunter_usr10/vuh/avengersWC/textui/textui.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile ) && $(MAKE) -e -f Makefile distdir DISTDIR=$(DISTDIR)/textui
