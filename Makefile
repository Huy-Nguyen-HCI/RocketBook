...
qmake_all: sub-model-qmake_all sub-unittest-unittest-qmake_all sub-database-qmake_all FORCE

make_first: sub-model-make_first sub-unittest-unittest-make_first sub-database-make_first  FORCE
all: sub-model-all sub-unittest-unittest-all sub-database-all  FORCE
clean: sub-model-clean sub-unittest-unittest-clean sub-database-clean  FORCE
distclean: sub-model-distclean sub-unittest-unittest-distclean sub-database-distclean  FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) .qmake.stash
install_subtargets: sub-model-install_subtargets sub-unittest-unittest-install_subtargets sub-database-install_subtargets FORCE
uninstall_subtargets: sub-model-uninstall_subtargets sub-unittest-unittest-uninstall_subtargets sub-database-uninstall_subtargets FORCE
...
distdir: sub-model-distdir sub-unittest-unittest-distdir sub-database-distdir FORCE
